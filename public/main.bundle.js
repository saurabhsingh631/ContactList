...
var ContactService = /** @class */ (function () {
    ...
    ContactService.prototype.getContacts = function () {
        return this.http.get('api/contacts').map(function (res) { return res.json(); });
    };
    ContactService.prototype.addContact = function (newContact) {
        var headers = new __WEBPACK_IMPORTED_MODULE_1__angular_http__["a" /* Headers */]();
        headers.append('Content-Type', 'application/json');
        return this.http.post('api/contact', newContact, { headers: headers }).map(function (res) { return res.json(); });
    };
    ContactService.prototype.deleteContact = function (id) {
        return this.http.delete('api/contact/' + id).map(function (res) { return res.json(); });
    };
...
var ContactsComponent = /** @class */ (function () {
    ...
    ContactsComponent.prototype.addContacts = function () {
        var _this = this;
        var newContact = {
        ...
        this.contactService.addContact(newContact).subscribe(function (contact) { _this.contacts.push(contact); _this.getContacts(); });
    };
